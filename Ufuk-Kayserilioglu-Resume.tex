...
\begin{tabular}{r|p{11cm}}
  \textsc{Sep 2014 - Present}   & Director at \textsc{Paralaus Technologies}, Istanbul \\
                                & \emph{Software Development Consultancy} \\
...
\section{Work Details}
\begin{longtable}{r|p{11cm}}
  \exptitle{Paralaus Technologies}{Sep 2014 - Present}

                                & Providing full-stack application development consultancy and services to overseas customers from around the world and managing the global workforce that provides these services. \\
  \multicolumn{2}{c}{} \\
